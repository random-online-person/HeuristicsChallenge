...
#            print("\nReached %2.2f%% accuracy!!" %(ACCURACY_THRESHOLD*100))
...
history=model.fit(X_train, y_train, validation_data=(X_test,y_test),  batch_size=64, epochs=40, validation_split=0.3,callbacks=[checkpoint])
...
print("%s: %.2f%%" % ("Final Accuracy is", score[1]*100))
